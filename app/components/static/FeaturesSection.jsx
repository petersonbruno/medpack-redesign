...
export default function FeaturesSection() {
  return (
    <section className="w-full bg-[rgba(240,248,255,1)]">
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:pl-8">
              <h2 className="font-poppins font-bold text-3xl md:text-4xl mb-6 text-[#0B7CD0]">
                Explore More About MedPack
              </h2>
              <p className="font-poppins text-lg text-gray-700 mb-8 leading-relaxed">
                Say goodbye to long wait times and frustration, and hello to a
                more efficient and convenient way to manage your healthcare
                needs.
              </p>
            </div>

            {/* Right Side - YouTube Preview */}
            <div className="relative">
              <div className="relative w-full h-[400px] rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-80 h-72 bg-gray-800 rounded-lg overflow-hidden shadow-2xl">
                    <Image
